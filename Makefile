...
all : $(BAR) $(DENSITY) $(GENERAL) $(SCARRED) $(SPIRAL) $(STABILITY)
...
%.o: %.cpp Action_Angle_Basis_Functions/*.h Bar2D/*.h DF_Class/*.h DF_Function/*.h nBody/Box/Box.h Potential_Density_Pair_Classes/*.h Spiral2d/*.h Volterra_Solver/*.h
